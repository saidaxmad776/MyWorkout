...
class CalendarView: UIView {
    ...
    private func setupViews() {
        ...
        collectionView.register(CallendarCollectionViewCell.self, forCellWithReuseIdentifier: idCalendarCell)
    }
...
extension CalendarView: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: idCalendarCell, for: indexPath) as? CallendarCollectionViewCell else { return UICollectionViewCell()}
